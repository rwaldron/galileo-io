...
Pin.prototype.write = function(value) {
  ...
  if (state.isPwm) {
    ...
    if (isServo) {
      ...
      // Convert 8 bit value to fractional value (%)

      // Notes:
      //
      // - PWM on Edison has known hardware issues that have been reported
      //  - https://github.com/intel-iot-devkit/mraa/issues/585
      //  - https://github.com/intel-iot-devkit/mraa/pull/586
      //
