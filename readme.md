...
Galileo-io is a Firmata-compatibility IO class for writing node programs that interact with [Galileo devices](https://www-ssl.intel.com/content/www/us/en/do-it-yourself/galileo-maker-quark-board.html).
